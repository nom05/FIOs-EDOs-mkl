...
######################################################################################################################################################
#if( Fortran_COMPILER_NAME MATCHES "gfortran" OR Fortran_COMPILER_NAME MATCHES "f95")   # f95 is an alias in my system
#
#  if(Fortran_COMPILER_NAME MATCHES "f95")
#     message( STATUS "f95 will be treated as an alias of gfortran, i.e., the same configuration will be used." )
#  endif( Fortran_COMPILER_NAME MATCHES "f95")
#
...
#    set( CMAKE_Fortran_FLAGS_ALL "${CMAKE_Fortran_FLAGS_ALL} -mcmodel=large" )  # -mcmodel exists for Linux only...
    set( CMAKE_Fortran_FLAGS_ALL "${CMAKE_Fortran_FLAGS_ALL}" )  # -mcmodel exists for Linux only...
  endif( LINUX )
  ...
  if( WANT_MKL )
    set( MKL_FLAGS "-qmkl=parallel" )
    message( STATUS "Linking with Intel MKL libraries support" )
  endif( WANT_MKL )
...
#  
#  
#endif( Fortran_COMPILER_NAME MATCHES "gfortran" OR Fortran_COMPILER_NAME MATCHES "f95")   # f95 is an alias in my system
...
set( USER_FLAGS "${OPT_FLAGS} ${LIB_FLAGS} ${CHECK_FLAGS} ${WARN_FLAGS} ${SSE_FLAGS} ${IPO_FLAGS} ${OPENMP_FLAGS} ${MKL_FLAGS} ${STATIC_FLAGS} ${INCLUDE_FLAGS} ${PACKAGE_FLAGS}" )
